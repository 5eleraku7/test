...
output_file = 'USsocks5.txt'
user_ids_file = 'users.txt'
proxy_list_url = 'https://raw.githubusercontent.com/elliottophellia/proxylist/refs/heads/master/results/socks5/country/US/psocks5_US_checked.txt'

#proxy_list_url = base64.b64decode(encoded_proxy_list_url).decode()
#https://raw.githubusercontent.com/elliottophellia/proxylist/refs/heads/master/results/socks5/country/US/psocks5_US_checked.txt
...
def save_active_proxies(proxy_list_url, output_file, max_proxies=2000):
    try:
        ...
        if response.status_code == 200:
            ...
            random_active_proxies = random.sample(active_proxies, min(500, len(active_proxies)))
...
def log_reputation(proxy, availability):
    logger.info(f"address : {proxy} is {availability}")
